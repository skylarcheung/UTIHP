...
nprdf <- read.csv('/Users/skylar/new_npr_page_posts.csv')
...
write.csv(npr,"/Users/skylar/Desktop/nprPosts.csv", row.names = FALSE)
    #to do the same with the dataframe that includes posts w/ videos only
write.csv(videonpr,"/Users/skylar/Desktop/nprVideoPosts.csv", row.names = FALSE)
